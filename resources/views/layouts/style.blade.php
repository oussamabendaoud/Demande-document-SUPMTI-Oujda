            ...
            <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-white">
                <div class="position-sticky">
                    <div class="list-group list-group-flush mx-3 mt-4">
                        ...
                        @endif
                        @if(Auth::check() && Auth::user()->hasRole('scolarite|Admin'))
                        ...
                        <div class="btn-group shadow-0 mb-2 dropend">
                            <button
                              type="button"
                              class="list-group-item list-group-item-action py-2 dropdown-toggle"
                            ...
                            <ul class="dropdown-menu">
                              <li><a class="dropdown-item {{ Request::is('users') ? 'active' : '' }}" href="{{ route('users.index') }}">Manage Users</a></li>
                              <li><a class="dropdown-item {{ Request::is('roles') ? 'active' : '' }}" href="{{ route('roles.index') }}">Manage Role</a></li>
                            </ul>
                        </div>
                        @endif
